...
def extract_model_brand(self, brand_model):
    ...
    # pride 141
        ...
        if 'ex' in i['value'].lower():
            ...
            self['tip'] = 'SX'
    elif 'پراید' in i['value'] and ('صندوق‌' in i['value'] or 'صندوق' in i['value']): #this two صندوق not same
        self['brand'] = 'پراید'
        self['model'] = 'صندوق‌دار'
    elif 'پراید' in i['value'] and 'هاچ' in i['value']:
        self['brand'] = 'پراید'
        self['model'] = 'هاچبک'
    elif 'پراید' in i['value'] and ('استیشن' in i['value'] or 'سفری' in i['value']):
        self['brand'] = 'پراید'
        self['model'] = 'استیشن'
    ...
    #peugeut
        ...
        self['brand'] = 'هایما'
        self['model'] = 'S7'
    elif 'هایما' in i['value'] and '8s' in i['value'].lower():
        self['brand'] = 'هایما'
        self['model'] = '8S'
        ...
        if 'مونتاژ' in i['value'].lower():
            ...
            self['tip'] = 'سدان'
    elif ('کیا' in i['value'] or 'سایپا' in i['value']) and 'سراتو' in i['value']:
        self['brand'] = 'کیا'
        self['model'] = 'سراتو'
        if '1600' in i['value'].lower():
            self['tip'] = '1600cc'
            ...
            self['tip'] = '2000cc'
    elif ('کیا' in i['value'] or 'سایپا' in i['value']) and 'سورنتو' in i['value']:
        self['brand'] = 'کیا'
        self['model'] = 'سورنتو'
    ...
    elif 'بسترن' in i['value'] and 'b30' in i['value'].lower():
        self['brand'] = 'بسترن'
        self['model'] = 'B30'
        ...
        self['model'] = None
# new
    elif 'آئودی' in i['value'] and 'q5' in i['value'].lower():
        self['brand'] = 'آئودی'
        self['model'] = 'Q5'
    elif 'آئودی' in i['value'] and 'a4' in i['value'].lower():
        self['brand'] = 'آئودی'
        self['model'] = 'A4'
    elif 'آئودی' in i['value'] and 'tt' in i['value'].lower():
        self['brand'] = 'آئودی'
        self['model'] = 'TT'
        ...
        self['brand'] = 'بی ام و'
        self['model'] = 'Z4'
    elif ('بی‌ام‌و' in i['value'] or 'بی ام و' in i['value'] or 'ب ام و' in i['value']) and 'cs' in i['value'].lower() and '3.0' in i['value']:
        self['brand'] = 'بی ام و'
        self['model'] = 'CS3.0'
        ...
        self['brand'] = 'تارا'
        self['model'] = 'اتوماتیک'
    elif 'تارا' in i['value'] and 'دنده' in i['value']:
        self['brand'] = 'تارا'
        self['model'] = 'دنده ای'
        ...
        self['brand'] = 'تویوتا'
        self['model'] = 'ون'
    elif 'تویوتا' in i['value'] and 'استاوت' in i['value']:
        self['brand'] = 'تویوتا'
        self['model'] = 'استاوت'
        ...
        self['brand'] = 'نیسان'
        self['model'] = 'مورانو'
    elif 'نیسان' in i['value'] and ('وانت' in i['value'] or 'زامیاد' in i['value']):
        self['brand'] = 'نیسان'
        self['model'] = 'وانت'
        ...
        self['brand'] = 'زامیاد'
        self['model'] = 'شوکا'
    elif 'زامیاد' in i['value'] and 'z' in i['value'].lower() and '24' in i['value']:
        self['brand'] = 'نیسان'
        self['model'] = 'وانت'
    elif 'ریچ' in i['value']:
        self['brand'] = 'زامیاد'
    ...
    elif 'فونیکس' in i['value'] and 'fx' in i['value'].lower():
        self['brand'] = 'فونیکس'
        self['model'] = 'FX'
        if 'پرمیوم' in i['value']:
            self['tip'] = 'پرمیوم'
        ...
        self['model'] = 'کلوت'
    elif 'مکث موتور' in i['value'] and 'تیارا' in i['value']:
        self['brand'] = 'مکث موتور'
        self['model'] = 'تیارا'
    ...
    elif 'لندرور' in i['value'] and 'دیسکاوری' in i['value']:
        self['brand'] = 'لندرور'
        self['model'] = 'دیسکاوری'
    elif 'لندرور' in i['value'] and 'دیفندر' in i['value']:
        self['brand'] = 'لندرور'
        self['model'] = 'دیفندر'
    elif 'لندرور' in i['value'] and 'رنجرور' in i['value']:
        self['brand'] = 'لندرور'
        self['model'] = 'رنجرور'
        if 'اسپرت' in i['value']:
            self['tip'] = 'اسپرت'
        elif 'ایووک' in i['value']:
            self['tip'] = 'ایووک'
    elif 'لندرور' in i['value'] and 'فریلندر' in i['value']:
        self['brand'] = 'لندرور'
        self['model'] = 'فریلندر'
